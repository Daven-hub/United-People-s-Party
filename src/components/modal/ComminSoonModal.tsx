    ...
    >
      ...
      >
        ...
        <div className="space-y-6 flex flex-col items-center text-gray-800 text-sm sm:text-base leading-relaxed">
          ...
          <span className='font-medium text-[1.2rem] max-md:text-[.86rem] space-x-3'>Nous contactez via <NavLink className={'text-blue-700 font-semibold'} to={'mailto:info@upp-ppu.cm'}>info@upp-ppu.cm</NavLink></span>
